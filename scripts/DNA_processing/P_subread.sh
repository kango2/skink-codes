...
if [ "$FROM_TRIMMOMATIC" = "YES" ]; then
    ...
    do
        echo -e "subread-align -t 1 -T ${PBS_NCPUS} --sortReadsByCoordinates -i ${workingdir}/subread_${directory_name}/index/genome -r ${workingdir}/trimmomatic_${directory_name}/${col2}_trimmed_1P.fq.gz -R ${workingdir}/trimmomatic_${directory_name}/${col2}_trimmed_2P.fq.gz -o ${workingdir}/subread_${directory_name}/mapping/${col2}_subread.bam"
