...
if [ "$P1_trimmomatic_subread_bamcoverage" = "YES" ] || [ "$P2_trimmomatic_subread" = "YES" ] || [ "$P3_subread_bamcoverage" = "YES" ] || [ "$P4_repeatmodeler_repeatmasker" = "YES" ] || [ "$trimmomatic" = "YES" ] || [ "$subread" = "YES" ] || [ "$bamCoverage" = "YES" ] || [ "$trinity" = "YES" ] || [ "blastxtranslation" = "YES" ] || [ "$repeatmodeler" = "YES" ] || [ "$repeatmasker" = "YES" ]; then
    echo -e "//===========================\\\\\\\\\n||          WELCOME          ||\n||           v1.0            ||\n\\\\\\===========================//"
